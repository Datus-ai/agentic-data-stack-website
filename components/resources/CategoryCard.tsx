...
export default function CategoryCard({ title, slug, description, icon, toolCount }: CategoryCardProps) {
  ...
  return (
    ...
    >
      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600/20 to-blue-500/20 text-violet-400 transition-colors group-hover:text-violet-300">
        {iconNode}
      </div>
